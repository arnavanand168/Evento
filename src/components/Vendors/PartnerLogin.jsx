...
const PartnerLogin = () => {
  ...
  return (
    ...
    >
      <div className="relative bg-white/95 shadow-2xl rounded-2xl p-8 w-[340px] md:w-[400px] flex flex-col items-center mx-auto">
        {mode === "login" ? (
          <>
            <h2 className="text-3xl font-bold text-gray-900 mb-2 mt-2">Partner Login</h2>
          ...
          <>
            <h2 className="text-3xl font-bold text-gray-900 mb-2 mt-2">Partner Sign Up</h2>
            <p className="text-sm text-gray-500 mb-5 text-center">Create your Evento partner account to get started</p>
