...
const BIRTHDAY_PACKAGES = {
  Delhi: [
    {
      icon: "/icons/birthday-cake.png",
      title: "Delhi Birthday Bash",
      features: [
        "15+ Guests",
        "Theme Decor",
        "Birthday Cake",
...
const BirthdayPackages = () => {
  ...
  const packages = BIRTHDAY_PACKAGES[city] || [];
  ...
  return (
    <div className="min-h-screen bg-white py-8 px-4 flex flex-col items-center">
      ...
      <h1 className="text-2xl font-bold mb-8 text-center">Birthday Packages in {city}</h1>
